...
ActiveRecord::Schema[8.0].define(version: 2025_04_20_005336) do
  ...
  create_table "company_synonyms", charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_company_synonyms_on_company_id"
  end

  add_foreign_key "company_synonyms", "companies"
end
